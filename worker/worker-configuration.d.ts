/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f638b19a168c5681c6664a0256b34769)
...
interface __BaseEnv_Env {
	...
	TEAMPLUS_SESSION: DurableObjectNamespace<import("./src/index").TeamplusSession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TeamplusSession";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEFAULT_ACCOUNT_ID" | "TURSO_URL" | "TURSO_AUTH_TOKEN" | "COOKIE_UPLOAD_SECRET" | "TEAMPLUS_BASE" | "TEAMPLUS_DB_KEY">> {}
}
